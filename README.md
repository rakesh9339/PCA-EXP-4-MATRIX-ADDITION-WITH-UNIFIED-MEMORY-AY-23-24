...
```
## OUTPUT:
![image](https://github.com/user-attachments/assets/7fa78294-44e6-4218-863b-ec8fa78b3e98)

## RESULT:
Thus the program has been executed by using unified memory. It is observed that removing memset function has given less/more 0.053935 sec time.
